<!-- Edit Modal -->
<div class="modal fade" id="edit{{$asset->id}}">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><b>Edit Asset</b></h4>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <small class="text-muted">Current file: {{ $asset->file }}</small>
                        </div>
                    </div>
                </div>
...
<!-- Delete Modal -->
<div class="modal fade" id="delete{{$asset->id}}">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <form class="form-horizontal" method="POST" action="{{ route('assets.destroy', $asset->id) }}">
                ...
                @method('DELETE')
                <div class="modal-body">
                    <p>Are you sure you want to delete this asset file: <b>{{ $asset->file }}</b>?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal">
                        <i class="fa fa-close"></i> Close
